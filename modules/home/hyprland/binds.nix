  ...
  wayland.windowManager.hyprland.settings = {
    bindd =
      ...
      ++ [
        ...
        "$modifier SHIFT,C, Google Contacts, exec, gtk-launch google-contacts"
        "$modifier SHIFT,A, Google Gemini - New Chat, exec, gtk-launch google-gemini"
        "$modifier SHIFT,M, Google Messages, exec, gtk-launch google-messages"
        "$modifier SHIFT,P, Google Photos, exec, gtk-launch google-photos"
        "$modifier SHIFT,X, Plex, exec, gtk-launch plex"
